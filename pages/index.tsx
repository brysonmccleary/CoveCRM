      ...
      <main className="min-h-screen bg-white text-gray-900">
        ...
        <nav className="flex justify-between items-center py-6 px-6 shadow-sm">
          ...
          <div className="space-x-4">
            <Link href="/login">
              <button className="text-sm text-gray-600 hover:text-blue-600 font-medium cursor-pointer">Login</button>
            </Link>
            <Link href="/signup">
        ...
        <section className="py-20 px-6 max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Everything you need to sell more policies</h2>
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ["Power Dialer", "Call leads from any number, with local presence and automatic logging."],
              ["2-Way SMS Inbox", "Text back and forth with leads in real time. Full conversation tracking included."],
              ["AI Follow-Up Bot", "Automatically follow up with unresponsive leads and book appointments for you."],
              ["Google Calendar Sync", "Appointments sync instantly with your real calendar, two-way."],
              ["Lead Import + Smart Folders", "Upload from CSV or Google Sheets. Automatically categorize leads by type."],
              ["Call Summaries + Recording", "Every call gets a smart AI summary plus optional audio recording."],
            ].map(([title, description], i) => (
              <div key={i} className="border rounded-xl p-6 shadow-sm hover:shadow-md transition cursor-pointer">
        ...
        <section className="bg-gray-100 py-20 px-6 text-center">
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-10">
            ...
            <ul className="text-left text-gray-700 mb-6">
              <li className="mb-2">✔ 1 Free Phone Number ($2/month each additional)</li>
            ...
            <p className="text-lg font-medium mb-4">AI Upgrade (optional): +$50/month</p>
            <Link href="/signup">
        ...
        <section className="py-24 text-center px-6 bg-[#0f172a] text-white">
          ...
          <p className="text-lg mb-8">Join hundreds of top agents using CRM Cove to dominate telesales.</p>
          <Link href="/signup">
