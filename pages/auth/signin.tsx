      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 text-white flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="mb-8 flex flex-col items-center gap-3">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Sign in to CoveCRM</h1>
          ...
          <div className="rounded-2xl border border-blue-400/20 bg-blue-900/30 backdrop-blur-md shadow-2xl p-6">
            ...
            <button
              ...
              title={googleEnabled ? "Sign in with Google" : "Google not configured"}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 48 48">
                <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.6 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.7 6.1 29.6 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 19.5-9 19.5-20c0-1.2-.1-2.3-.3-3.5z"/>
                <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.3 15.9 18.8 12 24 12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.7 6.1 29.6 4 24 4 16 4 9 8.5 6.3 14.7z"/>
                <path fill="#4CAF50" d="M24 44c5.2 0 10.1-2 13.7-5.2l-6.3-5.2C29.3 36 26.8 37 24 37c-5.2 0-9.6-3.4-11.3-8l-6.6 5.1C9 39.6 16 44 24 44z"/>
                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1 2.6-3 4.6-5.6 6l6.3 5.2C38.9 36.4 41.5 31.7 41.5 24c0-1.2-.1-2.3-.3-3.5z"/>
              </svg>
