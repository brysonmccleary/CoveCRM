    ...
    <div className="max-w-xl mx-auto mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <p className="text-xs text-gray-500 mt-2">
          By confirming this appointment, you agree to receive a confirmation message and appointment reminder via SMS at the phone number you provide. Message and data rates may apply. Reply STOP to opt out.
        </p>
      </form>
    </div>
  );
