  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>
          FTC guidelines require proper affiliate disclosures in all promotions.
        </li>
      </ul>

      <h2 className="text-xl font-semibold mt-6 mb-2">4. Fraud & Abuse</h2>
      <p className="mb-4">
        If fraudulent or unethical behavior is detected, commissions may be
        withheld or revoked. This includes self-referrals, coupon abuse, or
        spamming.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">5. Termination</h2>
      <p className="mb-4">
        We reserve the right to suspend or terminate your affiliate access at
        any time for violating these terms.
      </p>
    </div>
  );
}
