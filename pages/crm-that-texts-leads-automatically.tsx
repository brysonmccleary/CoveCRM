...
export default function CRMThatTextsLeadsAutomaticallyPage() {
  const title = "CRM That Texts Leads Automatically | CoveCRM";
  const description =
    "CoveCRM is a CRM that texts leads automatically with SMS follow-up, AI SMS assistance, drip campaigns, appointment reminders, and organized conversations.";
  const url = "https://www.covecrm.com/crm-that-texts-leads-automatically";
        ...
        <div className="max-w-5xl mx-auto px-6 py-16 md:py-20">
          ...
          <div className="mt-10 space-y-8 [&_p]:text-slate-300 [&_p]:leading-8 [&_ul]:space-y-3 [&_ul]:pl-5 [&_ul]:list-disc [&_li]:text-slate-300 [&_a]:text-blue-300 [&_a]:transition [&_a:hover]:text-white">
              <section className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8 shadow-lg shadow-black/10">
                <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">Why Fast Follow-Up Matters</h2>
                        <p>
              ...
              <section className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8 shadow-lg shadow-black/10">
                <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">How CoveCRM Supports Texting Workflows</h2>
                        <ul>
                          <li>AI SMS assistant for lead replies</li>
                          <li>Prebuilt drip campaigns</li>
                          <li>Appointment reminders and follow-up workflows</li>
                          <li>Two-way SMS conversations in one place</li>
                        </ul>
              </section>
              ...
              <section className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8 shadow-lg shadow-black/10">
                ...
                <div className="rounded-xl border border-white/10 bg-[#020617]/40 p-5">
                  <h3 className="text-lg font-semibold text-white">What is an automatic texting CRM?</h3>
                  <p>It is a CRM that can send SMS follow-up and keep conversations tied to each lead record.</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-[#020617]/40 p-5">
                  <h3 className="text-lg font-semibold text-white">Does CoveCRM include AI SMS?</h3>
                  <p>Yes. CoveCRM publicly positions an AI SMS assistant and SMS automation as part of the platform.</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-[#020617]/40 p-5">
