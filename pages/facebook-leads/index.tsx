      ...
      <div className="mx-auto max-w-6xl space-y-8 p-4 sm:p-6">
        ...
        <section className="rounded-2xl border border-blue-500/20 bg-[#0f172a] p-5 shadow-lg sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-base font-semibold text-white">Ad Command Center</h2>
            ...
            <button
              ...
              className="w-full rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-500 sm:w-auto"
            >
              Open Command Center
            </button>
          </div>
