...
const RecruitingDiscoveryJobSchema = new Schema(
  {
    ...
    // Editable so a customer can update the audience of a running campaign in
    // place; re-pointing these makes the next scan use the new criteria.
    ...
    audienceDescription: { type: String, required: true, trim: true },
