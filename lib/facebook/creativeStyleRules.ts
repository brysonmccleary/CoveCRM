  ...
  veteran: [
    {
      ...
      overlayData: {
        headline: "MILITARY \u00b7 WHOLE LIFE INSURANCE",
        subheadline: "No 2-Year Wait \u00b7 Immediate Coverage Up To $50,000",
        buttonLabels: ["$10,000", "$25,000", "$50,000", "$100,000"],
        ctaStrip: "Tap Your Age To See If You Qualify \u2192",
        benefitBullets: [
          "No 2-year waiting period",
          "Whole life \u2014 immediate coverage",
    ...
    },
    {
      ...
      overlayData: {
        ...
        subheadline: "Tap Your Age To See If You Qualify",
        buttonLabels: ["Under 50", "50\u201360", "61\u201370", "71\u201379"],
        ctaStrip: "Tap Your Age To See If You Qualify \u2192",
        benefitBullets: [],
      },
    },
    {
      ...
      subjectDirection: "veteran-aged civilian man age 55-70 with family at home, warm patriotic color palette, civilian setting \u2014 NO military uniforms, NO government insignia",
      buttonStyle: "none",
      ctaStyle: "Learn More",
      offerStyle: "family_protection",
      overlayData: {
        headline: "\u2022BUILT FOR VETERANS\u2022",
        subheadline: "Private Coverage For Veterans and Their Families",
        buttonLabels: [],
        ctaStrip: "Learn More \u2192",
        benefitBullets: [
          "Private market \u2014 not VA",
          "No exam options available",
          "Affordable monthly options",
        ],
      },
  ...
  trucker: [
    {
      ...
      subjectDirection: "three commercial semi trucks on open American highway at golden hour sunset, wide dramatic shot, no logos",
      buttonStyle: "age_bands",
      ctaStyle: "View Amount",
      ...
      overlayData: {
        ...
        subheadline: "What happens if the wheels stop turning \u2014 how will your income keep rolling?",
        buttonLabels: ["AGE 35-45", "AGE 45-55", "AGE 55-65", "AGE 65+"],
        ctaStrip: "See How It Works \u2192",
        benefitBullets: [
          "Life insurance with cash value potential",
          "Built for drivers planning ahead",
          "No exam options available",
        ],
      },
    },
    {
      ...
      overlayData: {
        headline: "TRUCKERS IUL",
        subheadline: "Attention Truckers: Get $500,000\u2013$1,000,000 in Life Insurance",
        buttonLabels: ["AGE 35-45", "AGE 45-55", "AGE 65+"],
        ctaStrip: "Learn More \u2192",
        benefitBullets: [
          "No medical exam required",
    ...
    },
    {
      ...
      overlayData: {
        headline: "TRUCK DRIVER LIFE INSURANCE",
        subheadline: "Coverage Built For People On The Road",
        buttonLabels: ["35\u201345", "45\u201355", "55\u201365", "65+"],
        ctaStrip: "Check My Options \u2192",
        benefitBullets: [
          "No exam options available",
