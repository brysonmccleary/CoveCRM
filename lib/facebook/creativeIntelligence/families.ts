...
const SEEDS: FamilySeed[] = [
  ...
  { id: "VET_CSS_DEPTH_SYSTEM", vertical: "veteran", creativeClass: "core", audiences: ["veteran"], layouts: ["hero_amount_age_grid", "audience_benefit_grid", "problem_consequence_offer", "full_bleed_text_overlay", "notice_letter_paper", "family_lifestyle_offer", "educational_explainer_card", "calculator_quiz_assessment"], hookClass: "veteran_direct_response_depth", offerClass: "coverage_review" },
  ...
  { id: "FE_CSS_DEPTH_SYSTEM", vertical: "final_expense", creativeClass: "core", layouts: ["hero_amount_age_grid", "audience_benefit_grid", "problem_consequence_offer", "notice_letter_paper", "family_lifestyle_offer", "comparison_two_column", "educational_explainer_card", "calculator_quiz_assessment"], hookClass: "final_cost_direct_response_depth", offerClass: "coverage_review" },
  ...
  { id: "MP_CSS_DEPTH_SYSTEM", vertical: "mortgage_protection", creativeClass: "core", layouts: ["hero_amount_age_grid", "audience_benefit_grid", "problem_consequence_offer", "notice_letter_paper", "family_lifestyle_offer", "comparison_two_column", "educational_explainer_card", "calculator_quiz_assessment"], hookClass: "mortgage_direct_response_depth", offerClass: "coverage_review" },
  ...
  { id: "IUL_CSS_DEPTH_SYSTEM", vertical: "iul", creativeClass: "core", layouts: ["audience_benefit_grid", "problem_consequence_offer", "family_lifestyle_offer", "comparison_two_column", "educational_explainer_card", "calculator_quiz_assessment"], hookClass: "iul_education_depth", offerClass: "education" },
  ...
  { id: "TRK_CSS_DEPTH_SYSTEM", vertical: "trucker", creativeClass: "core", audiences: ["trucker"], layouts: ["hero_amount_age_grid", "audience_benefit_grid", "problem_consequence_offer", "full_bleed_text_overlay", "family_lifestyle_offer", "educational_explainer_card", "calculator_quiz_assessment"], hookClass: "driver_direct_response_depth", offerClass: "driver_coverage_review" },
  ...
  { id: "ES_FE_EDUCATION_DEPTH", vertical: "final_expense", creativeClass: "core", audiences: ["spanish"], languages: ["es"], layouts: ["educational_explainer_card", "problem_consequence_offer", "audience_benefit_grid"], hookClass: "pasos_gastos_finales", offerClass: "educacion" },
  ...
  { id: "ES_VETERAN_AGE_OPTIONS", vertical: "veteran", creativeClass: "core", audiences: ["veteran", "spanish"], languages: ["es"], layouts: ["calculator_quiz_assessment", "hero_amount_age_grid"], hookClass: "edad_veterana", offerClass: "opciones" },
  { id: "ES_VETERAN_SERVICE_NOTICE", vertical: "veteran", creativeClass: "core", audiences: ["veteran", "spanish"], languages: ["es"], layouts: ["notice_letter_paper"], hookClass: "aviso_servicio", offerClass: "elegibilidad" },
  { id: "ES_VETERAN_COMPARE", vertical: "veteran", creativeClass: "adjacent", audiences: ["veteran", "spanish"], languages: ["es"], layouts: ["educational_explainer_card"], hookClass: "comparacion_veterana", offerClass: "comparacion" },
  { id: "ES_VETERAN_FAMILY_PLAN", vertical: "veteran", creativeClass: "experimental", audiences: ["veteran", "spanish"], languages: ["es"], layouts: ["family_lifestyle_offer", "problem_consequence_offer"], hookClass: "plan_familia_veterana", offerClass: "planificacion" },
  ...
  { id: "ES_TRUCKER_AGE_OPTIONS", vertical: "trucker", creativeClass: "core", audiences: ["trucker", "spanish"], languages: ["es"], layouts: ["calculator_quiz_assessment", "hero_amount_age_grid"], hookClass: "edad_conductor", offerClass: "opciones" },
  { id: "ES_TRUCKER_ROUTE_NOTICE", vertical: "trucker", creativeClass: "core", audiences: ["trucker", "spanish"], languages: ["es"], layouts: ["full_bleed_text_overlay"], hookClass: "aviso_ruta", offerClass: "elegibilidad" },
  { id: "ES_TRUCKER_COMPARE", vertical: "trucker", creativeClass: "adjacent", audiences: ["trucker", "spanish"], languages: ["es"], layouts: ["educational_explainer_card"], hookClass: "comparacion_conductor", offerClass: "comparacion" },
  { id: "ES_TRUCKER_FAMILY_PLAN", vertical: "trucker", creativeClass: "experimental", audiences: ["trucker", "spanish"], languages: ["es"], layouts: ["family_lifestyle_offer", "problem_consequence_offer"], hookClass: "plan_familia_conductor", offerClass: "planificacion" },
