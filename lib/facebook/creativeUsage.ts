...
function usageFields(draft: Record<string, any>) {
  return {
    ...
    executionId: String(draft?.cssExecutionId || ""),
    compositionVariant: String(draft?.cssCompositionVariant || ""),
    macroFamily: String(draft?.cssMacroFamily || ""),
    hierarchyTreatment: String(draft?.cssHierarchyTreatment || ""),
    panelStructure: String(draft?.cssPanelStructure || ""),
    typographyTreatment: String(draft?.cssTypographyTreatment || ""),
    selectorPresentation: String(draft?.cssSelectorPresentation || ""),
    benefitTreatment: String(draft?.cssBenefitTreatment || ""),
    backgroundTreatment: String(draft?.cssBackgroundTreatment || ""),
    ctaTreatment: String(draft?.cssCtaTreatment || ""),
